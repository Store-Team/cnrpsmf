...
final class ApiAutorisationConvoiExceptionelController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): JsonResponse
    {
        try {
            ...
            $autorisation = new AutorisationConvoiExceptionel();
            ...
            $autorisation->setLongueur($data['longueur'] ?? '');
            $autorisation->setVLargeur($data['v_largeur'] ?? '');
            $autorisation->setHauteur($data['hauteur'] ?? '');
    ...
    public function show(AutorisationConvoiExceptionel $autorisation): JsonResponse
    {
        return $this->json([
            ...
            'data' => [
                ...
                'longueur' => $autorisation->getLongueur(),
                'v_largeur' => $autorisation->getVLargeur(),
                'hauteur' => $autorisation->getHauteur(),
